            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Pune</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Flat No 201, near Fire Station Office, Amanora Park Town, Hadapsar, Pune, Maharashtra 411028
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={PuneImg} alt="Packers and Movers in Pune" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Pune</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Pune</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Pune</h2>
                    ...
                    <h2>Why Choose Safexpress Pune?</h2>
                    ...
                    <h2>Packers & Movers Charges in Pune</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Pune" />
                    </div>
