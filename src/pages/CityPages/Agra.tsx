            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Agra</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	Shop - 119 Mod, Road, near by Mahaprabhu Mandir, Bodla, Dehtora, Agra, Uttar Pradesh 282007			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={AgraImg} alt="Packers and Movers in Agra" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Agra</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Agra</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Agra</h2>
                    ...
                    <h2>Why Choose Safexpress Agra?</h2>
                    ...
                    <h2>Packers & Movers Charges in Agra</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Agra" />
                    </div>
