...
import AjmerImg from "../../assets/CityPages/Ajmer.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Ajmer</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Ajmer
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={AjmerImg} alt="Packers and Movers in Ajmer" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Ajmer</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Ajmer</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Ajmer</h2>
                    ...
                    <h2>Why Choose Safexpress Ajmer?</h2>
                    ...
                    <h2>Packers & Movers Charges in Ajmer</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Ajmer" />
                    </div>
