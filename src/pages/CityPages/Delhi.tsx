...
import DelhiImg from "../../assets/CityPages/delhi.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Delhi</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Delhi
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={DelhiImg} alt="Packers and Movers in Delhi" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Delhi</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Delhi</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Delhi</h2>
                    ...
                    <h2>Why Choose Safexpress Delhi?</h2>
                    ...
                    <h2>Packers & Movers Charges in Delhi</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Delhi" />
                    </div>
