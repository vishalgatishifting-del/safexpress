            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Calicut</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	Kurial Line, Nas Arcade, 61/1351, Cherooty Rd, Mananchira, Kozhikode, Kerala 673001			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={CalicutImg} alt="Packers and Movers in Calicut" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Calicut</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Calicut</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Calicut</h2>
                    ...
                    <h2>Why Choose Safexpress Calicut?</h2>
                    ...
                    <h2>Packers & Movers Charges in Calicut</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Calicut" />
                    </div>
