...
import NoidaImg from "../../assets/CityPages/noida.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Noida</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Noida
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={NoidaImg} alt="Packers and Movers in Noida" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Noida</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Noida</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Noida</h2>
                    ...
                    <h2>Why Choose Safexpress Noida?</h2>
                    ...
                    <h2>Packers & Movers Charges in Noida</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Noida" />
                    </div>
