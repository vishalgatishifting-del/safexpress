            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Kolhapur</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                           	Shop no.11, Shukratara Complex, opp. Mahavir Collage, Nagalapark, Kolhapur, Maharashtra 416002			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={KolhapurImg} alt="Packers and Movers in Kolhapur" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Kolhapur</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Kolhapur</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Kolhapur</h2>
                    ...
                    <h2>Why Choose Safexpress Kolhapur?</h2>
                    ...
                    <h2>Packers & Movers Charges in Kolhapur</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Kolhapur" />
                    </div>
