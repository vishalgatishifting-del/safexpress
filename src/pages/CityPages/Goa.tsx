            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Goa</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Flat no. 102, Jairam appartment, Sai parking, Belgam Highway, near Amigoz hotel, Curti, Ponda, Goa 403401
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={GoaImg} alt="Packers and Movers in Goa" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    ...
                    <h2>Our Packers & Movers Services in Goa</h2>
                    ...
                    <h2>Why Choose Safexpress Goa?</h2>
                    ...
                    <h2>Packers & Movers Charges in Goa</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Goa" />
                    </div>
