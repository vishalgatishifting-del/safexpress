...
import MumbaiImg from "../../assets/CityPages/mumbai.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Mumbai</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop No - 331, Ghansoli, Navi Mumbai,Maharashtra - 400701
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={MumbaiImg} alt="Packers and Movers in Mumbai" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Mumbai</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Mumbai</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Mumbai</h2>
                    ...
                    <h2>Why Choose Safexpress Mumbai?</h2>
                    ...
                    <h2>Packers & Movers Charges in Mumbai</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Mumbai" />
                    </div>
