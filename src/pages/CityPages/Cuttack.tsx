            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Cuttack</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	Sarthak Palace, Plot No.: 1570/1571, CDA Sector VI, Cuttack, Odisha 753014			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={CuttackImg} alt="Packers and Movers in Cuttack" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Cuttack</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Cuttack</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Cuttack</h2>
                    ...
                    <h2>Why Choose Safexpress Cuttack?</h2>
                    ...
                    <h2>Packers & Movers Charges in Cuttack</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Cuttack" />
                    </div>
