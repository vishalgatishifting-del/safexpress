            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Bhiwandi</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	Gala G-4 Gr floor, D Wing, Laksh APT, nr. Dhokali, Thane West, Kasheli, Bhiwandi, Maharashtra 421302			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={BhiwandiImg} alt="Packers and Movers in Bhiwandi" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Bhiwandi</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Bhiwandi</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Bhiwandi</h2>
                    ...
                    <h2>Why Choose Safexpress Bhiwandi?</h2>
                    ...
                    <h2>Packers & Movers Charges in Bhiwandi</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Bhiwandi" />
                    </div>
