...
import ImphalImg from "../../assets/CityPages/Imphal.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Imphal</span></h2>
                    ...
                    <div className="hero-image">
                        <img src={ImphalImg} alt="Packers and Movers in Imphal" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Imphal</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Imphal</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Imphal</h2>
                    ...
                    <h2>Why Choose Safexpress Imphal?</h2>
                    ...
                    <h2>Packers & Movers Charges in Imphal</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Imphal" />
                    </div>
