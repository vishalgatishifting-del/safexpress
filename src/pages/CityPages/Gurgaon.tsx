...
import GurgaonImg from "../../assets/CityPages/gurgaon.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Gurgaon</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Gurgaon
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={GurgaonImg} alt="Packers and Movers in Gurgaon" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Gurgaon</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Gurgaon</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Gurgaon</h2>
                    ...
                    <h2>Why Choose Safexpress Gurgaon?</h2>
                    ...
                    <h2>Packers & Movers Charges in Gurgaon</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Gurgaon" />
                    </div>
