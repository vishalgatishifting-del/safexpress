...
import ChennaiImg from "../../assets/CityPages/chennai.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Chennai</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 6/35, Anna Salai Rd, Ram Nagar, Nanganallur, Chennai, Tamil Nadu 600061
                    ...
                    <div className="hero-image">
                        <img src={ChennaiImg} alt="Packers and Movers in Chennai" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Chennai</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Chennai</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Chennai</h2>
                    ...
                    <h2>Why Choose Safexpress Chennai?</h2>
                    ...
                    <h2>Packers & Movers Charges in Chennai</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Chennai" />
                    </div>
