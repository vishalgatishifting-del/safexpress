...
import AhmednagarImg from "../../assets/CityPages/Ahmednagar.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Ahmednagar</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Ahmednagar
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={AhmednagarImg} alt="Packers and Movers in Ahmednagar" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Ahmednagar</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Ahmednagar</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Ahmednagar</h2>
                    ...
                    <h2>Why Choose Safexpress Ahmednagar?</h2>
                    ...
                    <h2>Packers & Movers Charges in Ahmednagar</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Ahmednagar" />
                    </div>
