            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Gandhidham</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                           	Plot No.54, near Lilasha Railway Crossing, Parthvi Nagar, Meghpar, Gandhidham, Gujarat 370205			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={GandhidhamImg} alt="Packers and Movers in Gandhidham" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Gandhidham</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Gandhidham</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Gandhidham</h2>
                    ...
                    <h2>Why Choose Safexpress Gandhidham?</h2>
                    ...
                    <h2>Packers & Movers Charges in Gandhidham</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Gandhidham" />
                    </div>
