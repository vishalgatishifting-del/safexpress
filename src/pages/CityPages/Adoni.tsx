...
import AdoniImg from "../../assets/CityPages/Adoni.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Adoni</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Adoni
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={AdoniImg} alt="Packers and Movers in Adoni" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Adoni</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Adoni</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Adoni</h2>
                    ...
                    <h2>Why Choose Safexpress Adoni?</h2>
                    ...
                    <h2>Packers & Movers Charges in Adoni</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Adoni" />
                    </div>
