            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Lucknow</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	DSE/555, near Indu Nursing Home, Sector C, Jankipuram, Lucknow, Uttar Pradesh 226021			
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={LucknowImg} alt="Packers and Movers in Lucknow" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Lucknow</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Lucknow</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Lucknow</h2>
                    ...
                    <h2>Why Choose Safexpress Lucknow?</h2>
                    ...
                    <h2>Packers & Movers Charges in Lucknow</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Lucknow" />
                    </div>
