            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Jamshedpur</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            	Shop No 115, Golmuri Rd, Tuiladungri, Sakchi, Jamshedpur, Jharkhand 831001		
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={JamshedpurImg} alt="Packers and Movers in Jamshedpur" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Jamshedpur</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Jamshedpur</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Jamshedpur</h2>
                    ...
                    <h2>Why Choose Safexpress Jamshedpur?</h2>
                    ...
                    <h2>Packers & Movers Charges in Jamshedpur</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Jamshedpur" />
                    </div>
