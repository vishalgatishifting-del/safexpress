...
import AgartalaImg from "../../assets/CityPages/Agartala.webp"
            ...
            <section id="city-page">
                ...
                <div className="city-hero">
                    <div className="hero-text">
                        <h1>Safexpress</h1>
                        <h2>Best Packers & Movers in <span>Agartala</span></h2>

                        <p className="address">
                            <LocationOnIcon />
                            Shop - 124, Kapoor Wali Gali, Rama Market, Munirka, New Agartala
                        </p>
                    ...
                    <div className="hero-image">
                        <img src={AgartalaImg} alt="Packers and Movers in Agartala" />
                    </div>
                </div>
                ...
                <div className="city-content">
                    <p>
                        Welcome to <strong>Safexpress Agartala</strong>. We provide safe,
                        affordable and professional relocation services for homes, offices,
                        vehicles and international moves.
                    </p>

                    <h2>🌍 International Packers & Movers in Agartala</h2>
                    <p>
                    ...
                    <h2>Our Packers & Movers Services in Agartala</h2>
                    ...
                    <h2>Why Choose Safexpress Agartala?</h2>
                    ...
                    <h2>Packers & Movers Charges in Agartala</h2>
                    <div className="charges">
                        <img src={chargesImg} alt="Packers and Movers Charges Agartala" />
                    </div>
