...
const SPECIAL_CITIES = ["Ghaziabad", "Agra", "Gurgaon", "Delhi", "Guwahati", "Mumbai", "Amritsar", "Ajmer", "Aligarh", "Hyderabad", "Bengaluru", "Noida", "Chennai", "Ahmedabad", "Almora", "Ahmednagar", "Alappuzha", "Angul", "Ankleshwar", "Arrah", "Asansol", "Anantnag", "Anantapur", "Amravati", "Along", "Akola", "Aizawl", "Adilabad", "Bhilai", "Agartala", "Bhagalpur", "Adoni", "Bareilly", "Ambala", "Ballari", "Bagalkot", "Aurangabad", "Balasore", "Ayodhya", "Bandipora", "Banashankari", "Baramulla", "Bardhaman", "Baripada", "Bargarh", "Basavanagudi", "Bathinda", "Belagavi", "Begusarai", "Belgaum", "Berhampore",  "Berhampur", "Bhadrak", "Bhavnagar", "Bharuch", "Bhiwandi", "Bhopal", "Bhubaneswar", "Bicholim", "Bidar", "Bikaner", "Bilaspur", "Bishnupur", "Buxar", "Bomdila", "Calicut", "Chamba", "Chandannagar", "Champhai", "Chandrapur", "Chandigarh", "Changlang", "Chhapra", "Chungthang", "Chittoor", "Chhattisgarh", "Chitradurga", "Mangalore", "Varanasi", "Nashik", "Kanpur", "Churachandpur", "Cuttack", "Goa", "Coimbatore", "Cuddalore", "Daporijo", "Greater Noida", "Kottayam", "Darbhanga", "Darjeeling", "Dharamshala", "Dhanbad", "Dehradun", "Dharwad", "Dibrugarh", "Dhule", "Dimapur", "Dindigul", "Durg", "Doda", "Erode", "Eluru", "Durgapur", "Dwarka", "Firozabad", "Faridabad", "Ganderbal", "Gandhidham", "Gorakhpur", "Gaya", "Gandhinagar", "Gangtok"];
