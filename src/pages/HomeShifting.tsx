...
import "../styles/HomeShifting.scss"
            ...
            <section id="home-shifting-sec" className="top-element">
                <div className="container">
                    ...
                    <div className="content household-items">
                        ...
                        <p>Safexpress provides complete home relocation solutions for all types of household goods:</p>
                        <ul>
